...
namespace HotelBooking.Application.Interfaces
{
    ...
    {
        Task<List<RoomTypeSummaryDto>> GetRoomTypesByHotelAsync(long hotelId, DateOnly? checkIn = null, DateOnly? checkOut = null);
        ...
        Task<List<RoomSearchResultDto>> SearchAsync(DateOnly? checkIn = null, DateOnly? checkOut = null);
