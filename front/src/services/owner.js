  ...
  return details.filter(Boolean).map((b) => {
    ...
    return {
      ...
      items: (b.items || []).map((i) => ({
        ...
        qty: Number(i.qty) || 1,
        nights: Number(i.nights) || 0,
        pricePerNight: Number(i.pricePerNight) || 0,
      ...
      paymentSenderWallet: b.paymentSenderWallet || null,
      paymentSenderName: b.paymentSenderName || null,
